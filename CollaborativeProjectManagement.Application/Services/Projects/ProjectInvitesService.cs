...
namespace CollaborativeProjectManagement.Application.Services.Projects
{
    public class ProjectInvitesService : IProjectInvitesService
    {
        ...
        public ProjectInvitesService(IProjectInvitesRepository projectInvitesRepository, IUserRepository userRepository, IProjectAuthorizationService projectAuthorizationService)
        {
